...
export function useDashboardView() {
  ...
  return {
    ...
    editingMessageText: chat.editingMessageText,
    deletingMessageId: chat.deletingMessageId,
    loadingChat: chat.loadingChat,
    loadingDMs: chat.loadingDMs,
    messageCount: chat.messageCount,
    bindMessagesContainerRef: chat.bindMessagesContainerRef,
    ...
    confirmDeleteMessage: chat.confirmDeleteMessage,
    cancelDeleteMessage: chat.cancelDeleteMessage,
    timeoutUserFromPopover: chat.timeoutUserFromPopover,
    banUserFromPopover: chat.banUserFromPopover,
