    ...
    <section class="dv-main">
      <header class="dv-top">
        <div class="dv-hero">
          ...
          <!-- Botón limpiar: solo visible en DMs -->
          <button
            v-if="activeConversation?.type === 'dm'"
            class="dv-clear-dm"
            :disabled="clearingDM"
            type="button"
            :title="`Limpiar historial de mensajes con ${activeConversation.name}`"
            @click="clearDM(activeConversation.id)"
          >
